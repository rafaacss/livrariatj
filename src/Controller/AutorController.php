...
final class AutorController extends AbstractController
{
    ...
    #[Route('/{CodAu}', name: 'app_autor_show', methods: ['GET'])]
    public function show(#[MapEntity(id: 'CodAu')] Autor $autor): Response
    {
    ...
    #[Route('/{CodAu}/edit', name: 'app_autor_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, #[MapEntity(id: 'CodAu')] Autor $autor, EntityManagerInterface $entityManager): Response
    {
        $form = $this->createForm(AutorType::class, $autor);
        $form->handleRequest($request);
